...
BEGIN_MESSAGE_MAP(CListBoxDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON8, &CListBoxDlg::OnBnClickedButton8)
END_MESSAGE_MAP()
...
BOOL CListBoxDlg::OnInitDialog()
{
	...
	m_ListBox.AddString(_T("3"));
	m_ListBox.AddString(_T("1"));
	m_ListBox.InsertString(0,_T("insert"));
...
void CListBoxDlg::OnBnClickedButton2()
{
	...
	m_ListBox.InsertString(nCount,str);
}


void CListBoxDlg::OnBnClickedButton8()
{
	// TODO: 在此添加控件通知处理程序代码
	CString str;
	m_ListBox.GetText(0,str);
	AfxMessageBox(str);
